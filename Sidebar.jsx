    ...
    <div className={`sidebar ${sidebar?"":"small-sidebar"}`}>
        <div className='shortcut-links'>
            ...
            <div className={`side-link ${category===20?"active":""}`} onClick={()=>setCategory(20)}>
                <img src={game_icon} alt='game'/><p>Game</p>
            </div>
        ...
        <div className="subscribed-list">
            ...
            <div className="side-link">
                 <img src={rose} alt='jack'/><p>Code with Pavi</p>
            </div>
            <div className="side-link">
                 <img src={butterfly} alt='simon'/><p>Nature Park</p>
            </div>
            <div className="side-link">
                 <img src={cat} alt='tom'/><p>Pets Worlds</p>
            </div>
            <div className="side-link">
                 <img src={nonveg} alt='megan'/><p>Food with Fayas</p>
            </div>
            <div className="side-link">
                 <img src={beauty} alt='came'/><p>National Beauties</p>
            </div>
        </div>
